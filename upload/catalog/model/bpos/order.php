<?php
class ModelBposOrder extends Model {
	...
	public function getOrders($data = array()) {
	    ...
	    if (!empty($data['filter_search'])) {
	        ...
	        $sql .= " AND (CONCAT(o.firstname, ' ', o.lastname) LIKE '%" . $search . "%' 
	    ...
	    if (!empty($data['filter_date_start']) && !empty($data['filter_date_end'])) {
	        $sql .= " AND DATE(o.date_added) BETWEEN '" . $this->db->escape($data['filter_date_start']) . "' 
	    ...
	    // Filter date added (spesifik)
	    if (!empty($data['filter_date_added'])) {
	        $sql .= " AND DATE(o.date_added) = DATE('" . $this->db->escape($data['filter_date_added']) . "')";
	    }

	    // Filter date modified (spesifik)
